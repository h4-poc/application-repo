...
```bash
bootstrap app create <APP_NAME> --app <APP_SPECIFIER> -p <PROJECT_NAME>
```
...
* ### Directory application
  ...
  #### Example:  
  ```bash
  bootstrap app create dir-example --app github.com/argoproj-labs/argocd-autopilot/examples/demo-dir/ -p <PROJECT_NAME> --type dir
  ```
...
* ### Kustomize application
  ...
  ```bash
  bootstrap app create hello-world --app github.com/argoproj-labs/argocd-autopilot/examples/demo-app/ -p <PROJECT_NAME> --type kustomize
  ```
